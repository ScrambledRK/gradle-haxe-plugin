...
import at.dotpoint.gradle.cross.variant.parser.flavor.TypeConverter
...
public class FlavorNotationParser implements IFlavorNotationParser
{
	...
	@Override
	FlavorRequirement parseNotation( Object o) throws TypeConversionException {
...
{
    @Override
    void convert( String notation, NotationConvertResult<? super FlavorRequirement> result ) throws TypeConversionException
    {
