...
import at.dotpoint.gradle.cross.variant.parser.buildtype.TypeConverter
...
{
    @Override
    void convert( String notation, NotationConvertResult<? super BuildTypeRequirement> result ) throws TypeConversionException
    {
